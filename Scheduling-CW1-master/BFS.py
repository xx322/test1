...
def check_multi_child(connection, start_node):
    ...
    for i in range(0, len(connection_multi)):
...
def schedule(start_node):
    ...
    if child_num == 1:
        ...
        check_multi_child(connection,connection[0][3])         #传过去应该重新计算
...
def schedules(node):
    ...
    if child_num == 1:
        ...
        check_multi_child(connection,connection[0][3])
